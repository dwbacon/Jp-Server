...
${(() => {
    ...
    return `<div class="space-y-6 stagger-in">` + months.map(m => {
        ...
        function renderExpenses() {
            ...
            let displayedExpenses = [...appData.expenses].sort((a,b) => parseLocalDate(b.date) - parseLocalDate(a.date));
